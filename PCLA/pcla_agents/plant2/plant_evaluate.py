...
export PLANT_VIZ={viz_file}
export PLANT_CHECKPOINT={cfg["checkpoint"]}
export PYTHONPATH={cfg["PYTHONPATH"]}
export CARLA_ROOT={cfg["carla_root"]}
export SCENARIO_RUNNER_ROOT={cfg["srunner"]}
export LEADERBOARD_ROOT={cfg["leaderboard"]}
export WORK_DIR={cfg["work_dir"]}
export IS_BENCH2DRIVE={cfg["b2d"]}
...
python -u {cfg["lb_script"]} --routes={route} \
--repetitions=1 \
--track={"SENSORS" if cfg["b2d"] else "MAP"} \
...
{"--nullrhi" if cfg["b2d"] and not cfg["rgb"] else ""}
''')
...
if __name__ == "__main__":
    ...
    #     "lb_script": "/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/leaderboard/leaderboard/leaderboard_evaluator.py",
    #     "leaderboard": "/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/leaderboard",
    #     "srunner": "/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/scenario_runner",
    #     "PYTHONPATH": "/home/gerstenecker/garage_2_cleanup/carla/PythonAPI:/home/gerstenecker/garage_2_cleanup/carla/PythonAPI/carla:/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/scenario_runner:/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/leaderboard:/home/gerstenecker/PlanT_2_cleanup/PlanT:/home/gerstenecker/PlanT_2_cleanup/Bench2Drive/leaderboard/team_code",
    #     "carla_root": "/home/gerstenecker/garage_2_cleanup/carla",
    #     "work_dir": "/home/gerstenecker/PlanT_2_cleanup/Bench2Drive",
    #     "b2d": 1,
    # }

    # TODO check that RGB is enabled here and in the agent, if it is false here and true in the agent it will lead to carla crashing
    cfg = {
        "checkpoint": args.checkpoint,
        ...
        "lb_script": "/home/gerstenecker/PlanT_2_cleanup/leaderboard_autopilot/leaderboard/leaderboard_evaluator_local.py",
        "leaderboard": "/home/gerstenecker/PlanT_2_cleanup/leaderboard_autopilot",
        "srunner": "/home/gerstenecker/PlanT_2_cleanup/scenario_runner_autopilot",
        "PYTHONPATH": "/home/gerstenecker/garage_2_cleanup/carla/PythonAPI:/home/gerstenecker/garage_2_cleanup/carla/PythonAPI/carla:/home/gerstenecker/PlanT_2_cleanup/scenario_runner_autopilot:/home/gerstenecker/PlanT_2_cleanup/leaderboard_autopilot:/home/gerstenecker/PlanT_2_cleanup/PlanT:/home/gerstenecker/PlanT_2_cleanup/carla_garage",
        "carla_root": "/home/gerstenecker/garage_2_cleanup/carla",
        "work_dir": "/home/gerstenecker/PlanT_2_cleanup",
        "b2d": 0,
    }
    ...
    for seed in seeds:
        ...
        # if cfg["rgb"]:
        #     os.makedirs(os.path.join(base_dir, "viz"), exist_ok=True)
        ...
        for route in routes:
            ...
            viz_file = os.path.join(base_dir, "viz", f"{route_id}")
    ...
    while job_queue:
        ...
        with open('eval_num_jobs.txt', 'r', encoding='utf-8') as f:
        ...
        for job in job_queue:
            ...
            # truncate old viz file if resubmit
            if os.path.exists(job["viz_file"]+".txt"):
                with open(job["viz_file"]+".txt", "w") as f:
                    pass
