...
from leaderboard_codes.sensor_interface import SensorInterface
...
class AutonomousAgent(object):
    ...
    def __init__(self, path_to_conf_file, route_index=None, vehicle=None):
        ...
        self.setup(path_to_conf_file, route_index, vehicle)

        self.wallclock_t0 = None

    def setup(self, path_to_conf_file, route_index=None, vehicle=None):
        """
    ...
    def run_step(self, input_data, timestamp, vehicle):
        """
