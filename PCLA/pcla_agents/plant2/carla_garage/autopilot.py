...
class AutoPilot(autonomous_agent_local.AutonomousAgent):
  ...
  def __call__(self, sensors=None, vehicle=None):
    """
    Override to accept vehicle parameter and pass it to run_step.
    """
    ...
    control = self.run_step(input_data, timestamp, sensors, vehicle)
  ...
  def _init(self, hd_map, vehicle):
    """
        ...
        Args:
            ...
            vehicle (carla.Vehicle): The ego vehicle object. # PCLA
        """
  ...
  def run_step(self, input_data, timestamp, sensors=None, plant=False, vehicle=None):
    """
